...
class CreateActivity extends Migration
{
    ...
    public function up()
    {
       \DB::statement("
            CREATE TABLE IF NOT EXISTS `activity` (
                ...
                INDEX `fk_activity_service1_idx` (`service_id` ASC, `service_vehicle_id` ASC, `service_vehicle_plate` ASC, `service_vehicle_state` ASC, `service_vehicle_person_id` ASC, `service_vehicle_person_users_id` ASC) VISIBLE,
    ...
    {
        \DB::statement('DROP TABLE activity;');
    }
}
